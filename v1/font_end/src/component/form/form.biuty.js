...
const FormBuitity=()=>{
    ...
    <form  id="form" encType="multipart/form-data" onSubmit={async(e)=>{
        ...
        fomdata.append('product_type','beautify');
        fomdata.append('product_atrributes[Expiry]',Expiry);
        ...
        <table>
            ...
            <tr>
                <td>
                    ...
                    <td>
                    <input type="text" id="Expiry" required onChange={(e=>{
